          ...
          {props.isLoggedIn && (
            <>
              <div>
                <button
                  onClick={submit}
                  className="px-4 mx-1 py-1 bg-gray-800 text-white rounded font-light hover:bg-gray-700"
                >
                  Submit
                </button>
              </div>
          ...
          {!props.isLoggedIn && (
            <div>
              <Link href={`/auth/login`}>
                <button className="px-4 py-1 mx-1 bg-gray-800 text-white rounded font-light hover:bg-gray-700">
                  Login
                </button>
              </Link>
            </div>
