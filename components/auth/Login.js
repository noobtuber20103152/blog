          ...
          <div className="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
            ...
            <div className="flex flex-col pt-3 md:pt-8">
              ...
              <div className="flex flex-col pt-4">
                ...
                {passtype == "password" && (
                  <span
                    className="mt-2 text-right hover:cursor-pointer"
                    onClick={changePasstype}
                  >
                    <Eye className="text-left text-xl" />{" "}
                  </span>
                )}
                {passtype == "text" && (
                  <span
                    className="mt-2 text-left hover:cursor-pointer"
                    onClick={changePasstype}
                  >
                    <Lock className="text-left text-xl" />{" "}
                  </span>
                )}
              </div>
              <button
            ...
            <div className="text-center pt-12 pb-12">
              <p>
                ...
                <Link href="/components/auth/Register"> Register here.</Link>
              </p>
            </div>
          </div>
        </div>
