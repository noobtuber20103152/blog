                ...
                <div className="flex justify-center my-6 w-full lg:w-10/12  ">
                    <div className="flex flex-col lg:flex-row justify-center rounded-lg bg-white ">
                        <div className='lg:w-2/12 ' >
                            <Image loader={myLoader} className=" hover:scale-105 duration-300 hover:cursor-pointer h-[12rem] w-12/12 lg:w-[12rem] object-cover rounded-lg " src={props.bgimage} height={500} width={500} alt="" />
                        </div>
