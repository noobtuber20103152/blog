...
function Createpost() {
  ...
  useEffect(() => {
    if (
      ...
      data.longdesc.length &&
      data.bgimage.length &&
      data.otherimages.length &&
      data.tags.length
    ) {
      setbtndisable(false);
    } else {
  ...
  return (
    <>
      ...
      <div className="text-center mt-5">
        <button
          onClick={livepreview}
          className={`bg-blue-600 mx-2 rounded-lg shadow-lg px-4 py-2 text-white`}
        >
          {form ? "Live Preview" : "Live Form"}
        </button>
      </div>
      {form && (
            ...
            <form className="w-full">
              ...
              <div className="flex flex-wrap -mx-3 mb-6">
                <div className="w-full px-3">
                  ...
                  <textarea
                    ...
                    name="shortdesc"
                    onChange={onchange}
                    className="focus:bg-white focus:outline-none p-2 resize-none focus:border-gray-500 w-full border bg-gray-200"
                    id=""
                    cols="30"
                    rows="4"
                  ></textarea>
                ...
                <div className="w-full px-3">
                  ...
                  <textarea
                    ...
                    placeholder=""
                    onChange={onchange}
                    className="p-2 focus:outline-none focus:bg-white w-full focus:border-gray-500 border bg-gray-200"
                    name="longdesc"
                    id=""
                    cols="30"
                    rows="10"
              ...
              <div className="flex flex-wrap -mx-3 mb-2">
                <div className="w-full  px-3 mb-6 md:mb-0">
                  ...
                  <input
                    ...
                    id="grid-city"
                    type="text"
                    placeholder="https://source.unsplash.com/random/900×700/?code"
                  />
                </div>
              </div>
              <div className="flex flex-wrap -mx-3 mb-2">
                <div className="w-full  px-3 mt-6 md:mb-0">
                  ...
                  <textarea
                    ...
                    onChange={onchange}
                    className="focus:bg-white p-2 resize-none focus:outline-none focus:border-gray-500 w-full border bg-gray-200"
                    name="otherimages"
                    id=""
                    cols="30"
                    placeholder="https://source.unsplash.com/random/900×700/?code, https://source.unsplash.com/random/900×700/?cricket"
                    rows="4"
                  ></textarea>
                </div>
              </div>
              ...
              {form && (
                <button
                  ...
                  disabled={btndisable}
                  className={`${
                    btndisable ? "bg-blue-400" : "bg-blue-600"
                  } rounded-lg shadow-lg px-4 py-2 text-white`}
                >
                  Submit
                </button>
              )}
