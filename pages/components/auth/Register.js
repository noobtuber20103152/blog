    ...
    return (
        <>
            ...
            <div class="w-full flex flex-wrap">
                <div class="w-full md:w-1/2 flex flex-col">
                    <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                        ...
                        <div class="flex flex-col pt-3 md:pt-8" >
                            ...
                            <div class="flex flex-col pt-4">
                                <label for="email" class="text-lg">Profile image link</label>
                                <input onChange={onchange} type="text" name="image" id="image" placeholder="image" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline" />
                            </div>
                            <div class="flex flex-col pt-4">
                                <label  for="email" class="text-lg ">Something about yourself</label>
                                <textarea cols="30" rows="3"onChange={onchange} type="text" name="about" id="about" placeholder="i'm a gamer." class="resize-none shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline" />
                            </div>
                ...
                <div class="md:w-1/2 w-full shadow-2xl">
